...
public class Parser {
   ...
   * <li>Identifiers</li>
   * <li><code>(<i>edu.cs3500.spreadsheets.sexp</i> ...)</code> for nested {@link Sexp}s</li>
   * </ul>
   *
  ...
  public static Sexp parse(String in) throws IllegalArgumentException {
    try {
      ...
      throw new IllegalArgumentException("Badly formatted edu.cs3500.spreadsheets.sexp: " + in + "\n" + a);
    }
  }
